...
Authverse v1.1.7 expands the **OAuth ecosystem** by adding support for major social providers, streamlining the setup process for Apple, Facebook, LinkedIn, and Twitter.
